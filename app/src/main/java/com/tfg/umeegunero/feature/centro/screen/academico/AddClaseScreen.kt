...
private fun ProfesorDropdown(
    ...
    ExposedDropdownMenuBox(
        ...
        OutlinedTextField(
            value = selectedProfesor?.let { "${it.nombre} ${it.apellidos}" } ?: "",
            onValueChange = {},
            readOnly = true,
            label = { Text(label) },
            trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded = expanded) },
...
@Composable
private fun ProfesoresAuxiliaresSelector(
    profesores: List<Usuario>,
            ...
            Row(
                ...
                Checkbox(
                    ...
                    onCheckedChange = { isSelected ->
                        onProfesorSelected(profesor.documentId, isSelected)
                    }
                )
                Text(
